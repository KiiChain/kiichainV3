...
# If you have run docker-cluster-start and build/kiichaind exist,
...
go mod edit -replace github.com/cosmos/cosmos-sdk=../kiichain-cosmos
go mod edit -replace github.com/tendermint/tendermint=../kiichain-tendermint

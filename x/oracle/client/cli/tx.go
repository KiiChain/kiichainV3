...
$ kiichaind tx oracle set-feeder terra1...
...
$ kiichaind tx oracle aggregate-vote 8888.0ukrw,1.243uusd,0.99usdr
...
$ kiichaind tx oracle aggregate-vote 1234 8888.0ukrw,1.243uusd,0.99usdr seivaloper1....
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {

...
kiichaind init "$MONIKER" --chain-id kiichain >/dev/null 2>&1
...
SEI_NODE_ID=$(kiichaind tendermint show-node-id)
...
# Create gentx
printf "12345678\n" | kiichaind gentx "$ACCOUNT_NAME" 10000000usei --chain-id kiichain
